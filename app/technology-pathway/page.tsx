...
import { FaUserFriends, FaChevronRight, FaChevronLeft } from "react-icons/fa";
...
interface TechnologyArea {
  ...
  description: string;
  item_title: string;
  list_items: TechListItem[];
  images: TechImage[];
}

const technology_areas: TechnologyArea[] = [
  {
    ...
    images: [
      {
        image: "/images/solar-powered-water-purification-system.avif",
        description: "Solar-powered water purification systems",
      },
      {
        image: "/images/sewage-system.avif",
        description: "Non-electric domestic sewage treatment system",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    images: [{ image: "/images/4x-waste-images.avif", description: "" }],
  },
  {
    ...
    images: [
      {
        ...
        description: "Aftrak boosts farming income to cover the costs of electricity for communities",
      },
    ],
  },
];
              ...
              <div className="w-full h-full relative">
                ...
                <div className="w-full h-full absolute z-10">
                  <Image
                    ...
                    fill
                    alt="Technology pathway hero background"
                  ...
                  <div className="w-full h-full max-w-[1400px] flex flex-col justify-end py-6 p-6">
                    <Reveal direction="up" delay={20} duration={700}>
                      ...
                      <p className="text-white mt-4 w-full max-w-[700px]">
                        Ronella Group collaborates with international partners, specialists, and
                        technology providers to design and deliver sustainable projects. We assess
                        and integrate proven, resilient, and scalable technologies tailored to local
                        needs, ensuring each solution is practical, feasible, and capable of creating
                        lasting positive impact for the communities we serve.
                      </p>
                    </Reveal>
                    <Reveal direction="up" delay={100} duration={700}>
                      <button
                        type="button"
                        className="bg-custom-green text-white p-3 w-fit px-8 mt-8 rounded-full flex flex-nowrap gap-2 transition-colors duration-150 ease-in-out hover:bg-red-700 cursor-pointer"
                      >
                  ...
                  >
                    ...
                    <div className="mt-4 ml-4">
                      ...
                      <ul className="mt-2 space-y-1">
                        {tech.list_items.map((item) => (
                          <li key={item.item} className="list-disc ml-5 text-gray-600">
                            {item.item}
                          </li>
                        ))}
                      </ul>
